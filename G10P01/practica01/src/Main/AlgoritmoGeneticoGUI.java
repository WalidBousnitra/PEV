        ...
        ejecutarButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				case "Funcion4b(Michalewicz)":
					AlgoritmoGenetico<Double> instancia =  new AlgoritmoGenetico<Double>(tamPoblacion, maxGeneraciones, probCruce,
							  probMutacion, precision, funcion, metodoSeleccion, metodoCruce, probElitismo, marcar2,d);
							instancia.run();
				...
				default:					
					AlgoritmoGenetico<Boolean> instancia2 =  new AlgoritmoGenetico<Boolean>(tamPoblacion, maxGeneraciones, probCruce,
						  probMutacion, precision, funcion, metodoSeleccion, metodoCruce, probElitismo, marcar2,d);
					instancia2.run();
